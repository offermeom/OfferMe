...
<v-app>
    <v-toolbar color="primary" elevation="2" dark class="toolbar-custom">
        ...
        size="40"
        v-if="showAvatar">
            <img src="https://images.unsplash.com/photo-1483909796554-bb0051ab60ad?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxzZWFyY2h8Mnx8Z2lybCUyMHByb2ZpbGV8ZW58MHx8MHx8&w=1000&q=80" alt="Profile Picture">
        </v-avatar>
        <span
        class="white--text"
        v-if="showUserName">
        ...
        <v-text-field v-if="showSearchInput" clearable v-model="search" label="Search" single-line hide-details @click:append="clearSearch"></v-text-field>
        <v-menu
            offset-y
          >
     ...
     <div class="d-flex justify-space-between my-6">
          ...
          <div class="mx-4">
            ...
            x-small
            color="primary"
            class="white--text py-3 elevation-0"
            >
            <!-- <v-icon class="mr-2" x-small>mdi-sort</v-icon> --> Sort
            </v-btn>
          </div>
        </div>
              ...
              <v-row @click="log(product)" class="list-row d-flex align-center mx-0">
                <v-col cols="2" class="d-flex justify-center">
                  ...
                  <v-col cols="7">
                    ...
                    <p class="ma-0 caption d-flex align-center grey--text">{{product.productstatus}}
                      <span class="ml-2"><v-avatar
