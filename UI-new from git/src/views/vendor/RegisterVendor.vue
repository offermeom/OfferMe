<template>
  <v-app>
    <v-container class="d-block my-auto">
      <div elevation="2">
        <h2 class="primary--text mt-4">Register as Vendor</h2>
        <div>
      ...
      <v-btn
        ...
        color="primary"
        outlined
        class="d-block mx-auto my-auto mt-7"
        @click="loginVendor()"
      >
        Login as Vendor
      </v-btn>
...
export default {
  ...
  data() {
    return {
      ...
      gstRules: [(v) => !!v || 'GSTIN is required'],
      confirmGstRules: [
        (v) => !!v || 'GSTIN is required',
        (v) => v === this.gst || 'GSTIN must match'
      ],
      passwordRules: [
